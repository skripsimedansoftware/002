<div class="box box-primary">
			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<a class="btn btn-sm btn-flat btn-danger" href="<?php echo base_url('pengguna/hapus_akun_bank/'.$value['id']) ?>" onclick="return confirm('Konfirmasi penghapusan')">Hapus</a>
					</td>
				</tr>
			<?php 
				}
	...
	<div class="box-footer">
		<a class="btn btn-primary btn-flat" href="<?php echo base_url('pengguna/tambah_akun_bank') ?>"><i class="fa fa-plus"></i> Tambah</a>
	</div>
</div>