<div class="box box-primary">
	...
	<form action="<?php echo base_url('transportasi/sunting/'.$transportasi['id']) ?>" method="post">
		<div class="box-body">
			<div class="col-lg-6">
				...
				<div class="form-group">
					...
					<input class="form-control" type="text" name="nomor_plat" placeholder="Nomor Plat" value="<?php echo set_value('nomor_plat', $transportasi['nomor_plat']) ?>">
					<?php echo form_error('nomor_plat', '<span class="help-block error">', '</span>'); ?>
				</div>
				<div class="form-group">
					<label>Beban Angkut (Kilogram)</label>
					<input class="form-control" type="text" name="beban_angkut" placeholder="Beban Angkut" value="<?php echo set_value('beban_angkut', $transportasi['beban_angkut']) ?>">
				...
				<div class="form-group">
					...
					<select class="form-control" name="sopir">
						<?php foreach ($sopir as $data) {?>
							<option value="<?php echo $data['id'] ?>" <?php echo ($transportasi['pengemudi'] == $data['id'])?'selected':''; ?>><?php echo $data['nama_lengkap']; ?></option>
						<?php } ?>
					</select>
